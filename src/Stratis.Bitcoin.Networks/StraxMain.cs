...
namespace Stratis.Bitcoin.Networks
{
    public class StraxMain : Network
    {
        public StraxMain()
        {
            ...
            this.DefaultPort = 19105;
            this.DefaultMaxOutboundConnections = 16;
            this.DefaultMaxInboundConnections = 100;
            this.DefaultRPCPort = 19104;
            this.DefaultAPIPort = 19103;
            this.DefaultSignalRPort = 19102;
            this.MaxTipAge = 2 * 60 * 60;
            this.MinTxFee = 10000;
            this.FallbackFee = 10000;
            this.MinRelayTxFee = 10000;
            this.RootFolderName = StraxNetwork.StraxRootFolderName + "3";
