...
{
    public class SmallRegTest : Network
    {
        ...
        public SmallRegTest()
        {
            this.Name = "SmallRegTest";
            this.NetworkType = NetworkType.Regtest;
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("Rmall"));
            this.DefaultPort = 38555;
            this.DefaultMaxOutboundConnections = 16;
            this.DefaultMaxInboundConnections = 100;
            this.DefaultRPCPort = 38554;
            this.DefaultAPIPort = 38553;
            this.DefaultSignalRPort = 38552;
            ...
            this.GenesisTime = 1602766034; // 15 October 2020
            this.GenesisNonce = 1; // TODO: Update this once the final block is mined
            this.GenesisBits = powLimit.ToCompact();
            this.GenesisVersion = 1;
            this.GenesisReward = Money.Zero;

            Block genesisBlock = StraxNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "regtestsmallgenesisblock");
            ...
            var cirrusFederationMnemonics = new[] {
                   ...
                   "ensure feel swift crucial bridge charge cloud tell hobby twenty people game",
            ...
            var encoder = new Bech32Encoder("tsmall");
