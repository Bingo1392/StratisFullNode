...
{
    public sealed class SmallTest : Network
    {
        ...
        public SmallTest()
        {
            ...
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("Tmall"));
            this.DefaultPort = 28555;
            this.DefaultMaxOutboundConnections = 16;
            this.DefaultMaxInboundConnections = 100;
            this.DefaultRPCPort = 28554;
            this.DefaultAPIPort = 28553;
            this.DefaultSignalRPort = 28552;
            ...
            this.GenesisNonce = 1831492; // TODO: Update this once the final block is mined
            ...
            Block genesisBlock = StraxNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "testsmallgenesisblock");
